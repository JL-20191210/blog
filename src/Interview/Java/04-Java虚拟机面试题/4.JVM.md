...
![面渣逆袭JVM篇封面图](assets/jvm-mianzhanixi-jvm.jpg)
...
![面渣逆袭已经提交 1438 次 GitHub 记录](assets/jvm-20250110113003.png)
...
![面渣逆袭JVM篇.pdf暗黑版](assets/jvm-20250121142305.png)
...
![截图来源于网络](assets/what-is-jvm-20231030185742.png)
...
![二哥的 Java 进阶之路：对象的创建过程](assets/jvm-20240404091445.png)
...
![二哥的 Java 进阶之路：JVM 使用的垃圾收集器](assets/jvm-20250110111618.png)
...
![三分恶面渣逆袭：指针碰撞和空闲列表](assets/jvm-10.png)
...
![rickiyang：缓存行污染](assets/jvm-20240320222058.png)
...
![rickiyang：Java 对象模型](assets/jvm-20240320221330.png)
...
![三分恶面渣逆袭：通过句柄访问对象](assets/jvm-13.png)
...
![三分恶面渣逆袭：方法逃逸](assets/jvm-37.png)
...
![二哥的 Java 进阶之路：top -Hp](assets/jvm-20240806090208.png)
...
![二哥的 Java 进阶之路：另外一组线程 id 的堆栈](assets/jvm-20240806092007.png)
...
![二哥的Java进阶之路：栈帧](assets/stack-frame-20231224090450.png)
...
![二哥的 java 进阶之路：GC Roots](assets/neicun-jiegou-20231227111238.png)
...
![pecuyu：动态链接](assets/gc-20240321085719.png)
...
![三分恶面渣逆袭：标记-复制算法](assets/jvm-23.png)
...
![有梦想的肥宅：G1 收集器](assets/gc-collector-20231228213824.png)
...
![三分恶面渣逆袭：G1收集器运行示意图](assets/jvm-36.png)
...
![二哥的 Java 进阶之路：JDK 默认垃圾收集器](assets/jvm-20240613111454.png)
...
![二哥的Java 进阶之路：jmap -heap](assets/jvm-20240806093153.png)

②、或者使用 `jmap -histo <pid>` 查看对象分布。

![二哥的Java 进阶之路：jmap -histo](assets/console-tools-20240106185906.png)

③、还有生成堆转储文件：`jmap -dump:format=b,file=<path> <pid>`。

![二哥的Java 进阶之路：jmap -dump](assets/console-tools-20240106184317.png)
...
![三分恶面渣逆袭：JMC主要界面](assets/jvm-41.png)
...
![二哥的 Java 进阶之路：JVM 调优](assets/jvm-20240417094311.png)
...
![三分恶面渣逆袭：CPU飙高](assets/jvm-43.png)
...
![haikuotiankongdong：top 命令结果](assets/jvm-20240527111502.png)
...
![haikuotiankongdong：Java 进程中的线程情况](assets/jvm-20240527111356.png)
...
![二哥的 Java 进阶之路：dump](assets/console-tools-20240106184317.png)

第三步，使用可视化工具分析 dump 文件，比如说 VisualVM，找到占用内存高的对象，再找到创建该对象的业务代码位置，从代码和业务场景中定位具体问题。

![二哥的 Java 进阶之路：分析](assets/view-tools-20240107134238.png)
...
![三分恶面渣逆袭：类的生命周期](assets/jvm-44.png)
...
![三分恶面渣逆袭：双亲委派模型](assets/jvm-46.png)
...
![三分恶面渣逆袭：双亲委派模型的三次破坏](assets/jvm-47.png)
...
![图片来源于美团技术博客](assets/jit-9a62fc02-1a6a-451e-bb2b-19fc086d5be0.png)
...
![Java 基础篇、集合框架篇、JVM 篇](assets/jvm-20250121141939.png)

网上的八股其实不少，这样可以给大家提供更多的选择，但面渣逆袭的含金量懂的都懂。

![球友开始面试后的感慨](assets/jvm-20250118111727.png)
...
![面渣逆袭JVM篇：epub 版本](assets/jvm-20250121142044.png)

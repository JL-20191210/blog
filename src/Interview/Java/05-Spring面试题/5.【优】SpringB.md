...
![面渣逆袭 Spring 篇封面图](assets/spring-mianzhanixi-spring1.jpg)
...
![面渣逆袭RSpring篇.pdf暗黑版](assets/redis-20250614154601.png)
...
![Spring Logo](assets/spring-165c27b4-2ea0-409a-8fa5-389c105db0fa.png)
...
![二哥的 Java 进阶之路：技术派@Autowired源码](assets/spring-20250615105532.png)

另外，Spring 还提供了 AOP，也就是面向切面编程，在我们需要做一些通用功能的时候特别有用，比如说日志记录、权限校验、事务管理这些，我们不用在每个方法里都写重复的代码，直接用 AOP 就能统一处理。

![技术派：AOP 事务源码](assets/spring-20250615105726.png)
...
![三分恶面渣逆袭：Spring特性](assets/spring-a0f0ef9d-3289-41ea-94c2-34b7e37ef854.png)
...
![技术派源码：@Permission注解加权限验证](assets/spring-20250615110533.png)
...
![技术派源码：Spring Boot 的约定大于配置](assets/spring-20250615111039.png)
...
![技术派源码：@MdcDot注解配合 AOP 完成日志追踪](assets/spring-20250615111917.png)
...
![技术派源码：@PostConstruct应用](assets/spring-20250615113219.png)
...
![星球嘉宾楼仔：Spring 源码解析](assets/spring-20241207102105.png)
...
![楼仔的 Spring 源码解析手册](assets/spring-20241207101910.png)
...
![中山大学的球友](assets/spring-20250615120504.png)
...
![Spring官网：模块划分](assets/spring-bb7c13ea-3174-4b32-84b8-821849ddc377.png)
...
![技术派源码：JdbcTemplate](assets/spring-20250616105042.png)
...
![技术派源码：BaseMapper](assets/spring-20250616105224.png)
...
![技术派：技术选型](assets/spring-20250616105807.png)
...
![大连海事大学硕河南理工大学本的球友](assets/spring-20250616110317.png)
...
![三分恶面渣逆袭：Spring常用注解](assets/spring-8d0a1518-a425-4887-9735-45321095d927.png)
...
![技术派源码：@Resource和@Autowired](assets/spring-20250617110609.png)
...
![技术派源码：@Value](assets/spring-20250617110755.png)

Web 开发的注解就更多了。`@RestController` 相当于 `@Controller` 加 `@ResponseBody`，用来做 RESTful 接口。

![技术派源码：web 开发的注解](assets/spring-20250617110859.png)
...
![技术派源码：AOP 相关注解](assets/spring-20250617111100.png)
...
![闽江学院的球友](assets/spring-20250617111727.png)
...
![三分恶面渣逆袭：Spring中用到的设计模式](assets/spring-ee1c5cee-8462-4bae-93ea-ec936cc77640.png)
...
![二哥的 Java 进阶之路：@Scope注解](assets/spring-20250618113356.png)
...
![技术派源码：JdbcTemplate](assets/spring-20250618114035.png)
...
![技术派源码：ApplicationListener](assets/spring-20250618114211.png)
...
![二哥的 Java 进阶之路：DefaultSingletonBeanRegistry](assets/spring-20250618115033.png)
...
![二哥的 Java 进阶之路：registerSingleton](assets/spring-20250618115153.png)
...
![重邮本，电子科技大学硕的球友](assets/spring-20250621062819.png)
...
![博客园 hiy1995：web 容器](assets/spring-20250621063345.png)
...
![北京交通大学本，北京航空航天大学硕的球友](assets/spring-20250621064205.png)
...
![图片来源于网络：IoC](assets/spring-20240310191630.png)
...
![三分恶面渣逆袭：引入IoC之前和引入IoC之后](assets/spring-619da277-c15e-4dd7-9f2b-dbd809a9aaa0.png)
...
![Martin Fowler’s Definition](assets/spring-20241117132929.png)
...
![技术派源码：构造方法的注入方式](assets/spring-20250622091928.png)

当然了，DI 并不是实现 IoC 的唯一方式，还有 Service Locator 模式，可以通过实现 ApplicationContextAware 接口来获取 Spring 容器中的 Bean。

![技术派源码：IoC 的Service Locator 模式](assets/spring-20250622093007.png)
...
![球友拿到了外企和电商的 offer](assets/spring-%E4%BA%8C%E5%93%A5%EF%BC%8C%E7%9B%AE%E5%89%8D%E6%8B%BF%E5%88%B0%E4%BA%86%E4%B8%A4%E4%B8%AAoffer%E3%80%82%E7%AC%AC%E4%B8%80%E4%B8%AA%E6%98%AF%E5%81%9Ab%E7%AB%AF%E7%94%B5.png)

### 7.能说一下IoC的实现机制吗？

好的，Spring IoC 的实现机制还是比较复杂的，我尽量用比较通俗的方式来解释一下整个流程。

![面渣逆袭：mini版本Spring IoC](assets/spring-1d55c63d-2d12-43b1-9f43-428f5f4a1413.png)
...
![技术派源码：DefaultListableBeanFactory](assets/spring-20250623094742.png)

第三步是 Bean 的实例化和初始化。这个过程比较复杂，Spring 会根据 BeanDefinition 来创建 Bean 实例。

![IoC的实现机制](assets/spring-20250623101221.png)
...
![贰师兄的屠宰场：各个注解的注入流程](assets/spring-20250628110426.png)

#### 你是怎么理解 Spring IoC 的？

IoC 本质上一个超级工厂，这个工厂的产品就是各种 Bean 对象。

![三分恶面渣逆袭：工厂运行](assets/spring-7678c40f-a48d-4bd5-80f8-e902ad688e11.png)
...
![球友拿到京东社招 offer](assets/spring-20250623105438.png)

### 8.说说BeanFactory和ApplicantContext的区别?

BeanFactory 算是 Spring 的“心脏”，而 ApplicantContext 可以说是 Spring 的完整“身躯”。

![三分恶面渣逆袭：BeanFactory和ApplicantContext](assets/spring-66328446-f89f-4b7a-8d9f-0e1145dd9b2f.png)

BeanFactory 提供了最基本的 IoC 能力。它就像是一个 Bean 工厂，负责 Bean 的创建和管理。他采用的是懒加载的方式，也就是说只有当我们真正去获取某个 Bean 的时候，它才会去创建这个 Bean。

![三分恶面渣逆袭：Spring5 BeanFactory继承体系](assets/spring-6e6d4b69-f36c-41e6-b8ba-9277be147c9b.png)
...
![三分恶面渣逆袭：Spring5 ApplicationContext部分体系类图](assets/spring-e201c9a3-f23c-4768-b844-ac7e0ba4bcec.png)
...
![技术派源码：获取ApplicationContext](assets/spring-20250625111259.png)
...
![球友对星球相见恨晚](assets/spring-20250625111617.png)
...
![球友拿到了杭州群核科技的 offer](assets/spring-20250627103801.png)
...
![stack overflow：bean 的初始化过程](assets/spring-20250628110931.png)
...
![技术派源码：UserService](assets/spring-20250628111222.png)

这种依赖注入的方式让对象之间的关系变得松耦合。

Spring 提供了多种 Bean 的配置方式，基于注解的方式是最常用的。

![二哥的 Java 进阶之路：Bean 的声明方式](assets/spring-20241224163146.png)
...
![技术派源码：@Component](assets/spring-20250628114006.png)

而 `@Bean` 则是由我们手动创建的，然后再交给 Spring 管理，我们对对象的创建过程有完全的控制权。

![技术派源码：@Bean](assets/spring-20250628114149.png)
...
![杭州电子科技大学本硕的球友](assets/spring-%E8%AE%A1%E7%AE%97%E6%9C%BA%E7%A7%91%E5%AD%A6%E4%B8%8E%E6%8A%80%E6%9C%AF.png)
...
![三分恶面渣逆袭：Bean生命周期五个阶段](assets/spring-595fce5b-36cb-4dcb-b08c-8205a1e98d8a.png)

第一个阶段是实例化。Spring 容器会根据 BeanDefinition，通过反射调用 Bean 的构造方法创建对象实例。如果有多个构造方法，Spring 会根据依赖注入的规则选择合适的构造方法。

![三分恶面渣逆袭：Spring Bean生命周期](assets/spring-942a927a-86e4-4a01-8f52-9addd89642ff.png)

第二阶段是属性赋值。这个阶段 Spring 会给 Bean 的属性赋值，包括通过 `@Autowired`、`@Resource` 这些注解注入的依赖对象，以及通过 `@Value` 注入的配置值。

![二哥的 Java 进阶之路：doCreateBean 方法源码](assets/spring-20240311101430.png)
...
![三分恶面渣逆袭：Bean生命周期源码追踪](assets/spring-d2da20a3-08d0-4648-b9a3-2fff8512b159.png)
...
![二哥的 Java 进阶之路：close 源码](assets/spring-20240311101658.png)
...
![技术派源码：ApplicationContextAware](assets/spring-20250630100429.png)
...
![读者拿到中科大读博、中海油、商飞北研](assets/spring-20250630101647.png)

### 12.为什么IDEA不推荐使用@Autowired注解注入Bean？

前情提要：当使用 `@Autowired` 注解注入 Bean 时，IDEA 会提示“Field injection is not recommended”。

![二哥的 Java 进阶之路：@Autowired](assets/spring-20241224164722.png)
...
![技术派：构造方法注入](assets/spring-20241224165628.png)
...
![技术派：@Resource](assets/spring-20241224170055.png)
...
![郑州大学本硕的球友](assets/spring-20250701154344.png)
...
![MarkusZhang：@Autowired](assets/spring-20250711165339.png)
...
![三分恶面渣逆袭：Spring四种自动装配类型](assets/spring-034120d9-88c7-490b-af07-7d48f3b6b7bc.png)
...
![ShawnBlog：Spring Boot 的自动装配](assets/spring-20250702101032.png)
...
![北航球友对星球的认可](assets/spring-20250702101812.png)
...
![三分恶面渣逆袭：Spring Bean支持作用域](assets/spring-08a9cb31-5a4f-4224-94cd-0c0f643a57ea.png)
...
![郑州大学硕，河北师范大学本的球友](assets/spring-20250704144758.png)
...
![三分恶面渣逆袭：Spring单例Bean线程安全问题](assets/spring-35dacef4-1a9e-45e1-b3f2-5a91227eb244.png)
...
![武汉理工大学本硕的球友](assets/spring-2023.09-2026.06.png)

### 17.什么是循环依赖?

简单来说就是两个或多个 Bean 相互依赖，比如说 A 依赖 B，B 依赖 A，或者 C 依赖 C，就成了循环依赖。

![三分恶面渣逆袭：Spring循环依赖](assets/spring-f8fea53f-56fa-4cca-9199-ec7f648da625.png)
...
![三分恶面渣逆袭：三级缓存](assets/spring-01d92863-a2cb-4f61-8d8d-30ecf0279b28.png)

以 A、B 两个类发生循环依赖为例：

![三分恶面渣逆袭：循环依赖](assets/spring-cfc09f84-f8e1-4702-80b6-d115843e81fe.png)
...
![三分恶面渣逆袭：A 对象工厂](assets/spring-1a8bdc29-ff43-4ff4-9b61-3eedd9da59b3.png)
...
![三分恶面渣逆袭：A 放入二级缓存，B 放入一级缓存](assets/spring-bf2507bf-96aa-4b88-a58b-7ec41d11bc70.png)
...
![三分恶面渣逆袭：AB 都好了](assets/spring-022f7cb9-2c83-4fe9-b252-b02bd0fb2435.png)
...
![三分恶面渣逆袭：循环依赖的几种情形](assets/spring-37bb576d-b4af-42ed-91f4-d846ceb012b6.png)
...
![二哥的 Java 进阶之路：循环依赖](assets/spring-20240310202703.png)
...
![二哥的编程星球已经 12 群了](assets/spring-20250705072809.png)
...
![三分恶面渣逆袭：二级缓存不行的原因](assets/spring-6ece8a46-25b1-459b-8cfa-19fc696dd7d6.png)
...
![幸云教育：三级缓存和循环依赖](assets/spring-20250706065436.png)

#### 如果缺少二级缓存会有什么问题？

二级缓存 earlySingletonObjects 主要是用来存放那些已经通过三级缓存的对象工厂创建出来的早期 Bean 引用。

![Minor王智：三级缓存](assets/spring-20250706065722.png)
...
![球友在星球里的秋招打卡记录](assets/spring-20250706070700.png)
...
![三分恶面渣逆袭：横向抽取](assets/spring-09dbcda4-7c1b-42d6-8520-1a5fc84abbde.png)
...
![stack overflow：JDK Proxy vs CGLIB Proxy](assets/spring-20250707112900.png)

#### Spring AOP 有哪些核心概念？

Spring AOP 是 AOP 的一个具体实现，我按照在工作/学习中理解的重要程度来说一下：

![DataFlair Team：AOP 核心概念](assets/spring-20250707114823.png)
...
![AOP 织入方式](assets/spring-20250707120111.png)
...
![AspectJ 官网](assets/spring-20240806100537.png)
...
![三分恶面渣逆袭：Spring AOP 通知方式](assets/spring-320fa34f-6620-419c-b17a-4f516a83caeb.png)
...
![技术派源码：环绕通知](assets/spring-20250707151431.png)
...
![二哥的 Java 进阶之路：BeanPostProcessor](assets/spring-20240806102547.png)
...
![学习计划表-三个月秋招冲刺计划](assets/spring-20250707153345.png)
...
![技术派项目：配置 AOP 切面](assets/spring-20240310180741.png)

第三步，在需要的地方加上 `@MdcDot` 注解。

![技术派项目：使用注解](assets/spring-20240310181233.png)
...
![吹二哥的面渣逆袭](assets/spring-20250708165006.png)

### 22.说说 Spring AOP 和 AspectJ 区别?

Spring AOP 只支持方法级别的织入，而且只能拦截 Spring 容器管理的 Bean。但是 AspectJ 几乎可以织入任何地方，包括方法、字段、构造方法、异常处理等等。

![三分恶面渣逆袭：Spring AOP和AspectJ对比](assets/spring-d1dbe9d9-c55f-4293-8622-d9759064d613.png)
...
![logbasex：JDK 动态代理和 CGLIB 代理](assets/spring-20250709150533.png)
...
![logbasex：JDK 动态代理](assets/spring-20250709152040.png)

如果用 CGLIB，代理对象会继承 TransferServiceImpl 类。

![logbasex：CGLIB 代理](assets/spring-20250709152111.png)
...
![技术派源码：AopAutoConfiguration](assets/spring-20250714162356.png)
...
![三分恶面渣逆袭：用户向客服提问题](assets/spring-c5c4b247-62dd-43a2-a043-da51c58f77c8.png)

我们可以用 JDK 动态代理来实现这个场景。JDK 动态代理的核心是通过反射机制在运行时创建一个实现了指定接口的代理类。

![三分恶面渣逆袭：JDK动态代理类图](assets/spring-65b14a3f-2653-463e-af77-a8875d3d635c.png)
...
![三分恶面渣逆袭：CGLIB动态代理类图](assets/spring-74da87af-20d1-4a5b-a212-3837a15f0bab.png)
...
![球友对星球的认可](assets/spring-20250711172049.png)
...
![Spring TransactionInterceptor](assets/spring-20250711173334.png)
...
![球友对面渣逆袭的认可](assets/spring-20250711174214.png)
...
![技术派源码：@Transactional注解](assets/spring-20250715175632.png)

第二个阶段发生在方法调用的运行阶段，当我们的代码调用那个被 `@Transactional` 注解修饰的方法时，实际上调用的是 Spring 创建的那个代理对象的方法。

![图片来源网易技术专栏](assets/spring-97493c7f-c596-4e98-a6a8-dab254d6d1ab.png)
...
![星环实习的球友对星球服务的认可](assets/spring-20250715180830.png)
...
![派聪明源码：@Transactional 不适用 this 调用](assets/spring-20250716144039.png)
...
![三分恶面渣逆袭：Spring默认支持的异常回滚](assets/spring-04053b02-3264-4d7f-b868-560a0333f08d.png)
...
![中国海洋大学本，四川大学硕的球友](assets/spring-20250716145121.png)

### 28.说说Spring事务的隔离级别？

事务的隔离级别定义了一个事务可以受其他并发事务影响的程度。SQL 标准定义的四个隔离级别，Spring 都支持，定义在 TransactionDefinition 接口中。

![二哥的 Java 进阶之路：TransactionDefinition](assets/spring-20240326082116.png)
...
![球友对星球的口碑](assets/spring-20250713101016.png)
...
![三分恶面渣逆袭：事务传播机制](assets/spring-a6e2a8dc-9771-4d8b-9d91-76ddee98af1a.png)
...
![派聪明源码：测试 protected 方法的事务是否生效](assets/spring-20250714171236.png)
...
![派聪明源码：protected 方法的事务生效结果](assets/spring-20250714171739.png)
...
![二哥的 Java 进阶之路：Spring MVC 组件](assets/spring-20250717090650.png)
...
![技术派源码：HandlerMapping](assets/spring-20250717091424.png)
...
![技术派源码：HandlerExceptionResolver](assets/spring-20250717092904.png)
...
![手写 Redis 的球友](assets/spring-20250717095915.png)
...
![图片来源于网络：SpringMVC工作流程图](assets/spring-20240506102456.png)

![_未来可期：SpringMVC工作流程图](assets/spring-20240506103022.png)
...
![技术派源码：Controller](assets/spring-20250718105710.png)
...
![技术派源码：RequestMappingHandlerAdapter](assets/spring-20250718105928.png)
...
![荣誉奖项基本拉满的球友](assets/spring-20250718111849.png)
...
![技术派源码：MappingJackson2HttpMessageConverter](assets/spring-20250719102056.png)
...
![三分恶面渣逆袭：Spring MVC Restful请求响应示意图](assets/spring-2da963a0-5da9-4b3a-aafd-fd8dbc7e1807.png)
...
![球友拿到京东实习 offer 了](assets/spring-20250719103018.png)
...
![SpringBoot图标](assets/spring-d9164ee6-5c86-4313-8fd9-efb9acfa5f0b.png)
...
![二哥的 Java 进阶之路：@EnableAutoConfiguration 源码](assets/spring-20240316121711.png)
...
![技术派源码：RabbitMqAutoConfig](assets/spring-20250726163759.png)
...
![三分恶面渣逆袭：Spring Boot的自动装配原理](assets/spring-df77ee15-2ff0-4ec7-8e65-e4ebb8ba88f1.png)
...
![亚信科技+新石器无人车的 offer](assets/spring-20250726164552.png)
...
![MyStarterProperties 注入示例](assets/spring-20240409114642.png)

启动项目，然后在浏览器中输入 `localhost:8081/hello`，就可以看到返回的内容是 `javabetter.cn`，说明我们的自定义 Starter 已经成功工作了。

![二哥的 Java 进阶之路：自定义 Spring Boot Stater](assets/spring-20240409114610.png)
...
![在小红书实习的球友真不少](assets/spring-20250727165400.png)

### 36.🌟Spring Boot 启动原理了解吗？

Spring Boot 的启动主要围绕两个核心展开，一个是 `@SpringBootApplication` 注解，一个是 `SpringApplication.run()` 方法。

![SpringBoot 启动大致流程-图片来源网络](assets/spring-68744556-a1ba-4e1f-a092-1582875f0da6.png)
...
![派聪明源码：启动类](assets/spring-20250810182536.png)
...
![沉默王二：技术派项目截图](assets/spring-20240327105552.png)
...
![感谢球友对星球的口碑](assets/spring-20250810185253.png)
...
![二哥星球的项目，轻松过简历初筛](assets/spring-20250811113549.png)
...
![itxiaoshen：Spring Cloud Alibaba](assets/spring-20250812185540.png)
...
![SpringCloud](assets/spring-2b988a72-0739-4fed-b271-eaf12589444f.png)
...
![PmHub 的系统架构图](assets/spring-20250812190247.png)
...
![技术派的启动类就有该注解的影子](assets/spring-20240422094511.png)
...
![帮球友修改简历拿到了哈啰的实习](assets/spring-20250816105951.png)
...
![二哥的Java 进阶之路：Spring Cache](assets/spring-20241031111306.png)
...
![铿然架构：Spring Cache 架构](assets/spring-20241031113743.png)

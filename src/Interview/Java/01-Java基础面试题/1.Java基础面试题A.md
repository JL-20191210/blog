...
![面渣逆袭Java 基础篇封面图](assets/javase-mianzhanixi-javase1.jpg)
...
![面渣逆袭Java 基础篇.pdf第二版](assets/javase-20241230173846.png)
...
![面渣逆袭Java 基础篇.pdf暗黑版](assets/javase-20241230174513.png)

## Java 概述

### 1.🌟什么是 Java？

![詹姆斯高斯林-下辈子还学 Java，还头秃](assets/one-01.png)
...
![技术派实战项目](assets/bdfa153fc82310f9ab862a1b3db0d0d7.png)

后面又做了微服务项目 [pmhub](https://javabetter.cn/zhishixingqiu/pmhub.html)，接触到了 Spring Cloud、Nacos、Sentinel、Seata、SkyWalking 等相关技术栈。

![pmhub](assets/1719412227941-391d1ca0-e312-4e81-a958-2eff29dbecd7.png)
...
![MYDB](assets/javase-20241223085416.png)
...
![三分恶面渣逆袭：Java语言特点](assets/javase-2.png)
...
![三分恶面渣逆袭：JDK、JRE、JVM关系](assets/javase-3.png)
...
![三分恶面渣逆袭：Java程序执行过程](assets/javase-4.png)
...
![三分恶面渣逆袭：编译与解释](assets/javase-5.png)
...
![二哥的 Java 进阶之路：Java数据类型](assets/nine-01.png)
...
![三分恶面渣逆袭：Java自动类型转换方向](assets/javase-7.png)
...
![三分恶面渣逆袭:装箱和拆箱](assets/javase-8.png)
...
![kaito：浮点数](assets/javase-20240321112428.png)
...
![kaito：25.125](assets/javase-20240321113232.png)
...
![三分恶面渣逆袭：面向对象和面向过程的区别](assets/javase-10.png)
...
![技术派实战项目源码截图](assets/javase-20241111172421.png)
...
![二哥的 Java 进阶之路：封装继承多态](assets/javase-20240330115129.png)
...
![截图来自博客园的小牛呼噜噜：虚拟方法表](assets/javase-20241126104207.png)
...
![二哥的 Java 进阶之路](assets/21-01.png)
...
![里氏替换原则由芭芭拉·利斯科夫提出，照片摄于2010年](assets/javase-20240321103119.png)
...
所以我们在新建线程类的时候一般推荐使用实现 Runnable 接口的方式，这样线程类还可以继承其他类，而不单单是 Thread 类。
...
![二哥的 Java 进阶之路：接口不能定义构造方法](assets/javase-20240512090855.png)
...
![二哥的 Java 进阶之路：final 修饰类](assets/javase-20240415111236.png)
...
![二哥的 Java 进阶之路：不能更改](assets/javase-20240415111725.png)

但是引用指向的对象内容可以改变。

![三分恶面渣逆袭：final修饰变量](assets/javase-13.png)
...
![二哥的 Java 进阶之路](assets/javase-20240407165712.png)
...
![二哥的 Java 进阶之路，String的equals()源码](assets/javase-20240425093626.png)
...
![三分恶面渣逆袭：Java引用数据值传递示意图](assets/javase-14.png)
...
![三分恶面渣逆袭：浅拷贝和深拷贝示意图](assets/javase-15.png)
...
![三分恶面渣逆袭：Java创建对象的四种方式](assets/javase-16.png)
...
![三分恶面渣逆袭：堆与常量池中的String](assets/javase-17.png)
...
![三分恶面渣逆袭：jdk1.8之前的字符串拼接](assets/javase-18.png)
...
![二哥的 Java 进阶之路：integer 源码](assets/javase-20240323080956.png)
...
![二哥的 Java 进阶之路：调整缓存池大小](assets/javase-20240323082802.png)
...
![三分恶面渣逆袭：Object类的方法](assets/javase-21.png)
...
![](assets/javase-20240313085055.png)
...
![三分恶面渣逆袭：Java异常体系](assets/javase-22.png)
...
![三分恶面渣逆袭：异常处理](assets/javase-23.png)
...
![二哥的Java 进阶之路：catch 和 finally 处理异常](assets/javase-20241008095737.png)
...
![二哥的 Java 进阶之路](assets/shangtou-01.png)
...
![二哥的 Java 进阶之路：IO 分类](assets/javase-20240404103618.png)
...
![三分恶面渣逆袭：BIO](assets/javase-27.png)
...
![三分恶面渣逆袭：NIO](assets/javase-28.png)

缓冲区 Buffer 也能极大提升一次 IO 操作的效率。

![三分恶面渣逆袭：NIO完整示意图](assets/javase-29.png)
...
![三分恶面渣逆袭：序列化和反序列化](assets/javase-30.png)
...
![二哥的Java 进阶之路：一个简单的 socket 通信](assets/socket-20230330192826.png)
...
![博客园struggler：经典的 RPC](assets/javase-20241128182231.png)
...
![Override注解](assets/javase-34.png)
...
![Autowired注解](assets/javase-35.png)
...
![三分恶面渣逆袭：Java反射相关类](assets/javase-36.png)
...
JDK 1.8 新增了不少新的特性，如 Lambda 表达式、接口默认方法和静态方法、Stream API、日期时间 API、Optional 类等。

![三分恶面渣逆袭：JDK1.8主要新特性](assets/javase-37.png)

①、Java 8 允许在接口中添加默认方法和静态方法。

> 接口扩充的时候不需要改动实现的类，常用的工具类可以直接放在接口中
...
![面渣逆袭Java 基础：epub 版本](assets/javase-20241231093226.png)

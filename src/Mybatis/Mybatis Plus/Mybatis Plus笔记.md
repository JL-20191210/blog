...
![img](assets\174257280847114.png)

然后用你的IDEA工具打开，项目结构如下：

![img](assets\174257281050817.png)

注意配置一下项目的JDK版本为JDK11。首先点击项目结构设置：

![img](assets\174257281359320.png)

在弹窗中配置JDK：

![img](assets\174257281583123.png)

接下来，要导入两张表，在课前资料中已经提供了SQL文件：

![img](assets\174257281851726.png)

对应的数据库表结构如下：

![img](assets\174257282063829.png)
...
![img](assets\174257283114638.png)
...
![img](assets\174257283808841.png)
...
![img](assets\174257284031944.png)

参数中的`Wrapper`就是条件构造的抽象类，其下有很多默认实现，继承关系如图：

![img](assets\174257284265547.png)

`Wrapper`的子类`AbstractWrapper`提供了where中包含的所有条件构造方法：

![img](assets\174257284496550.png)

而QueryWrapper在AbstractWrapper的基础上拓展了一个select方法，允许指定查询字段：

![img](assets\174257284825553.png)

而UpdateWrapper在AbstractWrapper的基础上拓展了一个set方法，允许指定SQL中的SET部分：

![img](assets\174257285042456.png)
...
![img](assets\174257285393159.png)
...
![img](assets\174257285793562.png)
...
![img](assets\174257285983065.png)
...
![img](assets\174257286175068.png)
...
![img](assets\174257286387571.png)
...
![img](assets\174257286592574.png)
...
![img](assets\174257286925077.png)
...
![img](assets\174257287144480.png)
...
![img](assets\174257287376683.png)
...
![img](assets\174257288081686.png)
...
![img](assets\174257288304189.png)
...
![img](assets\174257288954998.png)
...
![img](assets\1742572891599101.png)

在弹出的窗口中填写数据库连接的基本信息：

![img](assets\1742572893088104.png)

点击OK保存。

然后再次点击Idea顶部菜单中的other，然后选择`Code Generator`:

![img](assets\1742572894611107.png)

在弹出的表单中填写信息：

![img](assets\1742572896035110.png)
...
![img](assets\1742572897666113.png)
...
![img](assets\1742572901441116.png)
...
![img](assets\1742572904414119.png)
...
![img](assets\1742572906261122.png)
...
![img](assets\1742572907848125.png)
...
![img](assets\1742572909580128.png)
...
![img](assets\1742572911638131.png)
...
![img](assets\1742572918051140.png)

同时，为了使页面查询结果也是枚举格式，我们需要修改UserVO中的status属性：

![img](assets\1742572919434143.png)

并且，在UserStatus枚举中通过`@JsonValue`注解标记JSON序列化时展示的字段：

![img](assets\1742572920889146.png)

最后，在页面查询，结果如下：

![img](assets\1742572922463149.png)

## **3.4.JSON类型处理器**

数据库的user表中有一个`info`字段，是JSON类型：

![img](assets\1742572924346152.png)
...
![img](assets\1742572926276155.png)
...
![img](assets\1742572928069158.png)
...
![img](assets\1742572930285161.png)

同时，在User类上添加一个注解，声明自动映射：

![img](assets\1742572931943164.png)

测试可以发现，所有数据都正确封装到UserInfo当中了：

![img](assets\1742572933429167.png)

同时，为了让页面返回的结果也以对象格式返回，我们要修改UserVO中的info字段：

![img](assets\1742572935173170.png)

此时，在页面查询结果如下：

![img](assets\1742572936666173.png)
...
![img](assets\1742572939365176.png)
...
![img](assets\1742572941350179.png)
...
![img](assets\1742572943515182.png)
...
![img](assets\1742572946869185.png)
...
![img](assets\1742572948995188.png)

最后，则是分页实体PageDTO:

![img](assets\1742572950896191.png)
...
![img](assets\1742572957220194.png)
...
![img](assets\1742572961149197.png)

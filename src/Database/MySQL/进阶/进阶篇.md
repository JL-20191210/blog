...
> **DDL（数据定义语言）**、**DML（数据操作语言）\**和\**DQL（数据查询语言）**
...
![qrer231r123r.png](assets\qrer231r123r.png)

![qewf23f.png](assets\qewf23f.png)
